...
<center>
    ...
    <form action="Traitement3.php" method="POST">
        <fieldset>
            <legend>CALCUL DE RESISTANCE</legend>
       
        <label for="r1">R1:</label>
        <input type="text" name="r1" id="r1"><br><br>

        <label for="r2">R2:</label>
        <input type="text" name="r2" id="r2"><br><br>

        <label for="r3">R3:</label>
        <input type="text" name="r3" id="r3"><br><br>

        <input type="submit" name="valider" value="Calculer">
        </fieldset>
        <br><br>
        <fieldset>
            <legend>CALCUL DU CHOIX DE RESISTANCE</legend>
        <label for="choix">Veuilez faire un choix:</label>
        <select name="choix" id="choix">
            <option value=""></option>
            <option name="choix1" value="Résistance en série">Résistance en série</option>
            <option name="choix2" value="Résistance en parallèle">Résistance en parallèle</option>
        </select>
        <br><br>
        <input type="submit" name="choisir" value="Résultat">
        </fieldset>
    </form>
</body>
</html>