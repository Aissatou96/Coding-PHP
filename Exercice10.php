...
<center>
    ...
    <form method="POST"> 
    <label for="n1">Entier A:</label>
    <input type="text" id="n1" name="entierA"><br><br>

    <label for="n2">Entier B:</label>
    <input type="text" id="n2" name="entierB"><br><br>

    <label for="n3">Entier C:</label>
    <input type="text" id="n3" name="entierC"><br><br>
