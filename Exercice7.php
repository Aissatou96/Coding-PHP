...
<center>
    ...
    <form action="" method="POST">
        ...
        <label for="zone">ENTRER UN MONTANT A DECOMPOSER:</label>
        <input type="text" id="zone" name="mnt"><br><br>

        <input type="submit" name="valider" value="DECOMPOSER">
        </fieldset>
    </form>
    <!--Traitement-->
    <?php
       /* if (isset($_POST['valider'])){
            $montant = $_POST['mnt']
            if empty($_POST['mnt']){
                echo "Veuillez entrer un montant à décomposer";
            }else{
