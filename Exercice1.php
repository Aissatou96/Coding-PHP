...
<center>
    ...
    <fieldset>
    <legend>DIVISION DE DEUX ENTIERS</legend>
     <label for="entierA">Entrer un entier A:</label>
     <input type="text" id="entierA" name="nbreA"><br><br>

     <label for="entierB">Entrer un entier B:</label>
     <input type="text" id="entierB" name="nbreB"><br><br>
