...
<center>
    ...
    <form method="POST">
        <fieldset>
            <legend>DIVISION PAR SOUSTRACTIONS SUCCESSIVES</legend>
            <label for="n1">ENTRER UN ENTIER A:</label>
            <input type="text" id="n1" name="nbreA"><br><br>
            
            <label for="n2">ENTRER UN ENTIER B:</label>
            <input type="text" id="n2" name="nbreB"><br><br>
