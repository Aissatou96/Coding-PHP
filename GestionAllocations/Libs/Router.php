...
class Router{
 ...
 //Reecrire URL =>security/index
    function route(){
        ...
        try{
            /*spl_autoload_register(function()) avec comme paramètre une fonction callback permet 
            de faire le chargement dynamique des classes en définissant un chemin appelé ici $path*/
