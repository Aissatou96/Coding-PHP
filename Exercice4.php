...
<fieldset>
    <legend>X A LA PUISSANCE N</legend>

     <label for="reel">Entrer un réel:</label>
     <input type="text" id="reel" name="reel"><br><br>

     <label for="entier">Entrer un entier:</label>
     <input type="text" id="entier" name="entier"><br><br>
